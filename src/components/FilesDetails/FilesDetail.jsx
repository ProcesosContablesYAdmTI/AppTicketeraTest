  ...
  useEffect(() => {
    ...
    async function getAttachments() {
      try {
        ...
        const responseData = await sp_api_get_json_file(`/sites/APPTICKETERA/_api/web/lists/getbytitle('Request')/items?$filter=idSolicitud eq '${itemId}'&$select=AttachmentFiles,Title&$expand=AttachmentFiles`);
